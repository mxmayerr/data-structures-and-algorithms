// Scoreboard class to hold a record
...
public class Scoreboard {
    ...
    public void add(GameEntry e)
    {
        ...
        if (numEntries < board.length || e.compareTo(board[numEntries-1]) > 1) 
        {
            ...
            while (loc > 0 && board[loc-1].compareTo(e) < 1) 
    ...
    public GameEntry remove(int index) throws IndexOutOfBoundsException
    {
        ...
        if (index > numEntries-1)
            throw new IndexOutOfBoundsException("For this Scoreboard, index is invalid at: " + index);
        // otherwise
        else
        {
    ...
    public String toString()
    {
        ...
        while (loc < board.length && board[loc] != null)
        {
